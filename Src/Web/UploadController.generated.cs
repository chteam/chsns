...
namespace CHSNS.Controllers {
    public partial class UploadController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult Face() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.Face);
        }
        ...
        public class ActionNamesClass {
            public readonly string File = ("File").ToLowerInvariant();
            public readonly string Face = ("Face").ToLowerInvariant();
        }
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_UploadController: CHSNS.Controllers.UploadController {
        public T4MVC_UploadController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult File(string mode) {
