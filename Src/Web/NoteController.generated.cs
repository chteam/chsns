...
namespace CHSNS.Controllers {
    public partial class NoteController {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public System.Web.Mvc.ActionResult NoteList() {
            return new T4MVC_ActionResult(Area, Name, ActionNames.NoteList);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ActionNamesClass {
            ...
            public readonly string NoteList = ("NoteList").ToLowerInvariant();
            ...
            public readonly string News = ("News").ToLowerInvariant();
        }
        ...
        public class ViewNames {
            public readonly string Details = "~/Views/Note/Details.aspx";
            public readonly string Edit = "~/Views/Note/Edit.aspx";
            public readonly string Index = "~/Views/Note/Index.aspx";
            public readonly string News = "~/Views/Note/News.aspx";
            public readonly string NoteList = "~/Views/Note/NoteList.ascx";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public class T4MVC_NoteController: CHSNS.Controllers.NoteController {
        public T4MVC_NoteController() : base(Dummy.Instance) { }

        public override System.Web.Mvc.ActionResult Index(long? userid, int? p) {
        ...
        public override System.Web.Mvc.ActionResult NoteList(int p, int ep, long userid) {
            var callInfo = new T4MVC_ActionResult(Area, Name, ActionNames.NoteList);
            callInfo.RouteValueDictionary.Add("p", p);
