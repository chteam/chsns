...
public static class MVC {
    ...
    public static CHSNS.Controllers.EntryController Entry = new CHSNS.Controllers.T4MVC_EntryController();
    public static CHSNS.Controllers.EventController Event = new CHSNS.Controllers.T4MVC_EventController();
    public static CHSNS.Controllers.FriendController Friend = new CHSNS.Controllers.T4MVC_FriendController();
    public static CHSNS.Controllers.GroupController Group = new CHSNS.Controllers.T4MVC_GroupController();
    public static CHSNS.Controllers.HomeController Home = new CHSNS.Controllers.T4MVC_HomeController();
    public static CHSNS.Controllers.MessageController Message = new CHSNS.Controllers.T4MVC_MessageController();
    public static CHSNS.Controllers.NoteController Note = new CHSNS.Controllers.T4MVC_NoteController();
    public static CHSNS.Controllers.ProfileController Profile = new CHSNS.Controllers.T4MVC_ProfileController();
    public static CHSNS.Controllers.TestController Test = new CHSNS.Controllers.T4MVC_TestController();
    public static CHSNS.Controllers.UploadController Upload = new CHSNS.Controllers.T4MVC_UploadController();
    public static CHSNS.Controllers.UserController User = new CHSNS.Controllers.T4MVC_UserController();
    public static CHSNS.Controllers.VideoController Video = new CHSNS.Controllers.T4MVC_VideoController();
...
namespace T4MVC {
    ...
    public class AdminClass {
        ...
        public CHSNS.Web.Areas.Admin.Controllers.ApplicationController Application = new CHSNS.Web.Areas.Admin.Controllers.T4MVC_ApplicationController();
        public CHSNS.Web.Areas.Admin.Controllers.HomeController Home = new CHSNS.Web.Areas.Admin.Controllers.T4MVC_HomeController();
...
namespace Links {
    ...
    public static class Scripts {
        ...
        public static readonly string PageSet_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/PageSet.min.js") ? Url("PageSet.min.js") : Url("PageSet.js");
                      
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public static class Source {
            private const string URLPATH = "~/Scripts/Source";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class wysiwyg {
                private const string URLPATH = "~/Scripts/Source/wysiwyg";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                public static readonly string jquery_wysiwyg_jpg = Url("jquery.wysiwyg.jpg");
                ...
                public static readonly string wysiwyg_css = Url("wysiwyg.css");
                public static readonly string wysiwyg_gif = Url("wysiwyg.gif");
            }
