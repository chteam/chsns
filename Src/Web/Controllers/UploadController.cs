...
namespace CHSNS.Controllers {
    ...
    public partial class UploadController : BaseController
    {
        ...
        {
            var uploadPath = WebContext.Path.UploadPath(CHUser.UserId);
            ...
            var fileName = WebContext.Path.NewPhoto(CHUser.UserId, fileExtension);
            ...
            Services.UserInfo.ChangeFace(CHUser.UserId, System.IO.Path.Combine(WebContext.Site.Upload.Domain, photourl));
            //更新头像地址
            //将新头像地址存入相册
            return
