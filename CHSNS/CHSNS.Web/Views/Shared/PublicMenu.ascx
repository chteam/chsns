<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PublicMenu.ascx.cs" Inherits="CHSNS.Web.Views.Shared.PublicMenu" %>
...
--%><ul>
	...
	<li class="menuli">
		<a href="#" class="menu_title">查看</a>
		<ul class="menu_network">
			<li><%--$url.link("事件", "%{area='',controller='event',action='index'}")--%></li>
			<li><a href="/Message.aspx?mode=inbox">小条</a></li>
			<li><%--$url.link("好友请求", "%{area='',controller='user',action='FriendRequest'}")--%></li>
		</ul>
	</li>
	<li class="menuli">
		<a href="#" class="menu_title">应用</a>
		<ul class="menu_network">
