...
Ext.extend(ApiPanel, Ext.tree.TreePanel, {
    selectClass : function(cls){
        if(cls){
            ...
            this.selectPath('/root/mpiroot/' + parts.join('/'));
        }
    }
});
...
MainPanel = function(){
    ...
    MainPanel.superclass.constructor.call(this, {
        ...
        items: {
            id:'index-panel',
            title: 'Home',
            autoLoad: {url: '/admin/about.ashx', callback: this.initSearch, scope: this},
            iconCls:'icon-docs',
            autoScroll: true,
			tbar: [
				'Search: ', ' ',
	...
	initSearch : function(){
	    ...
	    var resultTpl = new Ext.XTemplate(
	        ...
	        '<div class="search-item">',
				...
				'<img src="/AdminStyle/images/default/s.gif" class="item-icon icon-{type}"/>{member}',
				'</a> ',
