...
namespace CHSNS.Models
{
    ...
    partial void DeleteTags(Tags instance);
		...
		public ChAlumnaDBDataContext() : 
				base(global::CHSNS.Models.Properties.Settings.Default.sq_mengleiConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnCityChanged();
		...
		[Association(Name="Profile_BasicInformation", Storage="_Profile", ThisKey="userid", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
    ...
    partial void OnTellMethodChanged();
		...
		[Association(Name="Profile_ContactInformation", Storage="_Profile", ThisKey="userid", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Profile Profile
		{
			get
			{
    ...
    partial void OnField2Changed();
		...
		[Association(Name="Profile_FieldInformation", Storage="_Profile", ThisKey="userid", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Profile Profile
		{
			get
			{
    ...
    partial void OnistellmeChanged();
		...
		[Association(Name="Note_LogTag", Storage="_LogTag", ThisKey="id", OtherKey="logid")]
		...
		[Association(Name="Note_Push", Storage="_Push", ThisKey="id", OtherKey="Logid")]
    ...
    partial void OnlogidChanged();
		...
		[Association(Name="Note_LogTag", Storage="_Note", ThisKey="logid", OtherKey="id", IsForeignKey=true)]
		public Note Note
		{
			get
			{
		...
		[Association(Name="Tags_LogTag", Storage="_Tags", ThisKey="tagid", OtherKey="id", IsForeignKey=true)]
		public Tags Tags
		{
			get
			{
    ...
    partial void OnJoinSocietyChanged();
		...
		[Association(Name="Profile_PersonalInformation", Storage="_Profile", ThisKey="userid", OtherKey="UserId", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Profile Profile
		{
			get
			{
    ...
    partial void OnInFieldChanged();
		...
		[Association(Name="Profile_BasicInformation", Storage="_BasicInformation", ThisKey="UserId", OtherKey="userid", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="Profile_ContactInformation", Storage="_ContactInformation", ThisKey="UserId", OtherKey="userid", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="Profile_FieldInformation", Storage="_FieldInformation", ThisKey="UserId", OtherKey="userid", IsUnique=true, IsForeignKey=false)]
		...
		[Association(Name="Profile_PersonalInformation", Storage="_PersonalInformation", ThisKey="UserId", OtherKey="userid", IsUnique=true, IsForeignKey=false)]
    ...
    partial void OnPushTimeChanged();
		...
		[Association(Name="Note_Push", Storage="_Note", ThisKey="Logid", OtherKey="id", IsForeignKey=true, DeleteOnNull=true, DeleteRule="CASCADE")]
		public Note Note
		{
			get
			{
    ...
    partial void OnReachTimeChanged();
		...
		[Association(Name="Tags_LogTag", Storage="_LogTag", ThisKey="id", OtherKey="tagid")]
		public EntitySet<LogTag> LogTag
		{
			get
			{
