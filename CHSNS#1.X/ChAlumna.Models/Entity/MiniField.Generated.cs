...
{
    /// <summary>
    /// The class representing the dbo.MiniField table.
    /// </summary>
        ...
        : LinqEntityBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MiniField"/> class.
        /// </summary>
        ...
        /// </summary>
        [Column(Name="pid", Storage="_pid", DbType="bigint NOT NULL", CanBeNull=false)]
        public long Pid
        {
            get { return _pid; }
            set
