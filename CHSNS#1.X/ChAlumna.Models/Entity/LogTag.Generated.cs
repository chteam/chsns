...
namespace CHSNS.Models
{
        ...
        : LinqEntityBase
    {
        ...
        public LogTag()
        {
            ...
            _tagTags = default(EntityRef<Tags>);
        }
        #endregion
        ...
        public long TagID
        {
            ...
            set
            {
                if (_tagID != value)
                {
                    if (_tagTags.HasLoadedOrAssignedValue)
                    {
        ...
        private EntityRef<Tags> _tagTags;

        /// <summary>
        /// Gets or sets the Tags association.
        /// </summary>
        [Association(Name="FK_LogTag_Tags", Storage="_tagTags", ThisKey="TagID", OtherKey="Id", IsForeignKey=true)]
        public Tags TagTags
        {
            get { return _tagTags.Entity; }
            set
            {
                Tags previousValue = _tagTags.Entity;
                if (previousValue != value || _tagTags.HasLoadedOrAssignedValue == false)
                {
                    OnPropertyChanging("TagTags");
                    if (previousValue != null)
                    {
                        _tagTags.Entity = null;
                        previousValue.TagLogTagList.Remove(this);
                    }
                    _tagTags.Entity = value;
                    if (value != null)
                    {
                        value.TagLogTagList.Add(this);
                        _tagID = value.Id;
                    }
                    else
                    {
