...
namespace CHSNS.Models
{
        ...
        : LinqEntityBase
    {
        ...
        {
            OnCreated();
            _tagidLogTagList = new EntitySet<LogTag>(
                new System.Action<LogTag>(this.Attach_TagidLogTagList),
                new System.Action<LogTag>(this.Detach_TagidLogTagList));
        }
        #endregion
        ...
        private EntitySet<LogTag> _tagidLogTagList;
        ...
        public EntitySet<LogTag> TagidLogTagList
        {
            ...
            set { _tagidLogTagList.Assign(value); }
        }
        
        [DebuggerNonUserCodeAttribute()]
        private void Attach_TagidLogTagList(LogTag entity)
        {
            OnPropertyChanging(null);
            entity.TagidTags = this;
            OnPropertyChanged(null);
        }
        
        [DebuggerNonUserCodeAttribute()]
        private void Detach_TagidLogTagList(LogTag entity)
        {
            OnPropertyChanging(null);
            entity.TagidTags = null;
            OnPropertyChanged(null);
        }
        #endregion
