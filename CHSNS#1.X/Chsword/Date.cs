namespace CHSNS{
	...
	public class Date
	{
		...
		static public string FormatTime(object d,string s){
			return Convert.ToDateTime(d).ToString(s);
		}
		static public string FormatTime(DateTime d,string s){
			return d.ToString(s);
		}
		static public string FormatTime(DateTime d)
		{
		...
		/// <returns></returns>
		static public double DivMinutes(DateTime oldtime) {
			TimeSpan st =  DateTime.Now- oldtime;
			return st.TotalMinutes;
			//.Minutes;
		}
		static public double DivMinutes(object oldtime) {
			DateTime dt;
		...
		static long DateDiff(string div,DateTime oldtime,DateTime nowtime){
			return DateAndTime.DateDiff(div, oldtime, nowtime,FirstDayOfWeek.Monday,FirstWeekOfYear.Jan1);
		}
		/// <summary>
		/// 时间与现在的时间间隔
		/// </summary>
		...
		static public string GetTimeDiv(DateTime dt){
		...
		/// <param name="dt">时间</param>
		/// <returns>间隔的中文</returns>
		static public string GetTimeDiv(string dt){
		...
		/// <param name="dt">时间</param>
		/// <returns>间隔的中文</returns>
		static public string GetTimeDiv(Object dt){
			return GetTimeDiv(Convert.ToDateTime(dt));
		}
		/// <summary>
		/// 获取天干或地枝的编号
		...
		public int SkyTree(DateTime dat, SkyTreeText i)
		{
			...
			int m = dat.Month;
			int d = dat.Day;
			Node = Dom.SelectSingleNode(string.Format("//item[@year={0}]", y));
			int start;
			int n;
			int result;
			if (i == SkyTreeText.地支)
			...
			if (byte.Parse(Node.Attributes["month"].InnerXml) == m & byte.Parse(Node.Attributes["day"].InnerXml) > d) result = result - 1;
		...
		{
			return XmlItemName(string.Format("//item[@id={0}]", num.ToString()), "name", "AnimalSign");
		}
		/// <summary>
		/// 获取生肖名
		/// </summary>
		...
		{
			return XmlItemName(string.Format("//item[@id={0}]", SkyTree(dat, SkyTreeText.天干).ToString()), "tree", "SkyTree");
		}
		/// <summary>
		/// 获取天干名
		/// </summary>
		...
		{
			return XmlItemName(string.Format("/root/item[@id={0}]", Num.ToString()), "name", "StarSign");
		}
		/// <summary>
		/// 获取星座编号
		/// </summary>
		...
		public int StarSign(DateTime dat)
		{
			...
			if ((((DateTime.Compare(temp, new DateTime(633100320000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633125376000000000L)) <= 0)) ? 1 : 0) != 0)
			{
				functionReturnValue = 1;
			}
			else
			{
				if ((((DateTime.Compare(temp, new DateTime(633126240000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633152160000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 2;
				}
				if ((((DateTime.Compare(temp, new DateTime(633153024000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633179808000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 3;
				}
				if ((((DateTime.Compare(temp, new DateTime(633180672000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633206592000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 4;
				}
				if ((((DateTime.Compare(temp, new DateTime(633207456000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633233376000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 5;
				}
				if ((((DateTime.Compare(temp, new DateTime(633234240000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633260160000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 6;
				}
				if ((((DateTime.Compare(temp, new DateTime(633261024000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633286944000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 7;
				}
				if ((((DateTime.Compare(temp, new DateTime(633287808000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633312000000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 8;
				}
				if ((((DateTime.Compare(temp, new DateTime(633312864000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633337920000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 9;
				}
				if ((((DateTime.Compare(temp, new DateTime(633338784000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633346560000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 10;
				}
				if ((((DateTime.Compare(temp, new DateTime(633032064000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633047616000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 10;
				}
				if ((((DateTime.Compare(temp, new DateTime(633048480000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633073536000000000L)) <= 0)) ? 1 : 0) != 0)
				{
					return 11;
				}
				if ((((DateTime.Compare(temp, new DateTime(633074400000000000L)) >= 0) && (DateTime.Compare(temp, new DateTime(633099456000000000L)) <= 0)) ? 1 : 0) != 0)
				{
