		...
		private bool SendEmail() {
			...
			*/
			...
			if (Attachments.Count != 0) {
				...
				SendBufferstr += "	boundary=\"=====" + (isHtml ? "001_Dragon520636771063_" : "001_Dragon303406132050_") + "=====\"" + enter + enter;
			}
			...
			if (Attachments.Count != 0) {
				for (int i = 0; i < Attachments.Count; i++) {
					...
					SendBufferstr += "--=====" + (isHtml ? "001_Dragon520636771063_" : "001_Dragon303406132050_") + "=====" + enter;
				...
				SendBufferstr += "--=====" + (isHtml ? "001_Dragon520636771063_" : "001_Dragon303406132050_") + "=====--" + enter + enter;
			}
